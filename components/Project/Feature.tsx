  ...
  return !right ? (
    <div className="flex gap-16 mt-14">
        <div data-aos="fade-up" className={`w-6/12 relative mb-20 ${feature.mb}`}>
          <img src={feature.image1} className={`w-6/12 ${feature.image1Class}`} alt="feature_1" />
    ...
    <div className="flex gap-16 mt-14">
        ...
        <div data-aos="fade-up" className={`w-6/12 relative mb-20 ${feature.mb}`}>
          <img src={feature.image1} className={`w-6/12 ml-auto ${feature.image1Class}`} alt="feature_1" />
